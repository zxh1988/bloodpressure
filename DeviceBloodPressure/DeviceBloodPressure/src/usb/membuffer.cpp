 ...
 * Author: liangbolin
 * 
 * Created on November 3, 2016, 4:50 PM
 */
#include "stdafx.h"
#include <assert.h>
#include <stdlib.h>
...
static inline void membuffer_initialize(
...
//int CMembuffer::membuffer_append(membuffer *m, const void *buf, size_t buf_len)
...
//int CMembuffer::membuffer_insert(membuffer * m, const void *buf, size_t buf_len,
//	size_t index)
